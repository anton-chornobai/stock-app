...
## The project covers the following concepts:
  ...
  - Framework [Gin](https://github.com/yourusername).
  - PostgreSQL (pgx driver) SQL queries. Using migrations for version control of DB.
  - Authentication and Authorization using [JWT](https://www.jwt.io/introduction#when-to-use-json-web-tokens), Middleware.
  - Application Configuration Working with environment variables.
  - Work with Docker. Deploying image to [Docker Hub](https://hub.docker.com/).
  - Using Slog
